...
export default function AstuteApp() {
  ...
  useEffect(() => {
    if (currentPage === "vip") {
      const t = setTimeout(() => setVipPopupOpen(true), 350);
    ...
    >
      ...
      <main className="relative z-[2] min-h-screen" style={{ WebkitOverflowScrolling: "touch" }}>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="rounded-xl p-3 flex items-center justify-between cursor-pointer active:scale-[0.98]"
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-[9px] font-bold font-mono" style={{ color: "var(--ast-gray)" }}>IDR</div>
                    <div className="text-[9px] font-mono" style={{ color: "rgba(148,163,184,0.6)" }}>3,6$</div>
        ...
        <PageWrapper pageName="ff-old-2k22" currentPage={currentPage}>
          ...
          {/* ─── Discord Verification Announcement ─── */}
          <Reveal delay={110}>
            <div className="rounded-2xl border relative overflow-hidden mb-4" style={{ background: "var(--ast-bg2)", borderColor: "rgba(37,99,235,0.25)" }}>
              <div className="absolute top-0 left-0 right-0 h-[2px]" style={{ background: "linear-gradient(90deg, #0c2d5a, #1d4ed8, #60a5fa, #93c5fd)" }} />
              <div className="p-4">
                <div className="flex items-center gap-2 mb-3">
                  <ShieldCheck className="w-3.5 h-3.5" style={{ color: "#60a5fa" }} />
                  <span className="font-mono text-[9px] font-bold tracking-[0.14em] uppercase" style={{ color: "var(--ast-gray)" }}>Announcement</span>
                </div>

                <div className="text-[13px] font-bold mb-3" style={{ color: "var(--ast-white)" }}>
                ...
                {/* Status Box: Berhasil (Orange) */}
                <div className="rounded-xl p-3 mb-2.5 flex items-center gap-3" style={{ background: "rgba(249,115,22,0.12)", border: "1px solid rgba(249,115,22,0.4)" }}>
                  <div className="w-7 h-7 rounded-full flex items-center justify-center shrink-0" style={{ background: "rgba(249,115,22,0.2)", border: "1.5px solid #f97316" }}>
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="#f97316" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                      <polyline points="20 6 9 17 4 12" />
                    </svg>
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="text-[12.5px] font-bold" style={{ color: "#f97316" }}>BERHASIL — Udah Join Discord</div>
                    <div className="text-[10px] mt-0.5" style={{ color: "rgba(249,115,22,0.8)" }}>Lanjut download, lu aman bos</div>
                  </div>
                </div>

                {/* Status Box: Gagal (White) */}
                <div className="rounded-xl p-3 mb-3 flex items-center gap-3" style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.2)" }}>
                  <div className="w-7 h-7 rounded-full flex items-center justify-center shrink-0" style={{ background: "rgba(255,255,255,0.08)", border: "1.5px solid rgba(255,255,255,0.6)" }}>
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="#ffffff" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                      <line x1="18" y1="6" x2="6" y2="18" />
                      <line x1="6" y1="6" x2="18" y2="18" />
                    </svg>
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="text-[12.5px] font-bold" style={{ color: "#ffffff" }}>GAGAL — Belum Join Discord</div>
                    <div className="text-[10px] mt-0.5" style={{ color: "rgba(255,255,255,0.7)" }}>Wajib join dulu, ga bisa lanjut download</div>
                  </div>
                </div>

                <a href="https://discord.gg/jujumarket" target="_blank" rel="noopener noreferrer"
                  className="block w-full py-3 rounded-xl text-center text-[12.5px] font-bold mb-2 cursor-pointer active:scale-[0.98]"
                  style={{
                ...
                <p className="text-center text-[9.5px]" style={{ color: "var(--ast-gray)" }}>
                  Setelah join, balik ke sini dan klik cek status
                </p>
              </div>
            </div>
          </Reveal>
